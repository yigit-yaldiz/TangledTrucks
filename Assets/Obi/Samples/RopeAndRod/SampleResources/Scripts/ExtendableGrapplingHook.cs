...
public class ExtendableGrapplingHook : MonoBehaviour
{
    ...
    private IEnumerator AttachHook()
    {
        ...
        blueprint.path.AddControlPoint(Vector3.zero, Vector3.zero, Vector3.zero, Vector3.up, 0.1f, 0.1f, 1, filter, UnityEngine.Color.white, "Hook start");
        blueprint.path.AddControlPoint(localHit.normalized * 0.5f, Vector3.zero, Vector3.zero, Vector3.up, 0.1f, 0.1f, 1, filter, UnityEngine.Color.white, "Hook end");
