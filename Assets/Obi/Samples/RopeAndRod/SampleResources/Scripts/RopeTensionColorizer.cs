...
public class RopeTensionColorizer : MonoBehaviour
{
    ...
    public UnityEngine.Color normalColor = UnityEngine.Color.green;
	public UnityEngine.Color tensionColor = UnityEngine.Color.red;
    ...
    void Update()
    {
        ...
        if (tenserFactor > 0)
        {
            ...
            localMaterial.color = UnityEngine.Color.Lerp(normalColor, tensionColor, lerpFactor * tenserFactor);
        }
        else
        {
