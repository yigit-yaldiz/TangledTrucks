...
public class GrapplingHook : MonoBehaviour
{
    ...
    private IEnumerator AttachHook()
    {
        ...
        blueprint.path.AddControlPoint(Vector3.zero, -localHit.normalized, localHit.normalized, Vector3.up, 0.1f, 0.1f, 1, filter, UnityEngine.Color.white, "Hook start");
        blueprint.path.AddControlPoint(localHit, -localHit.normalized, localHit.normalized, Vector3.up, 0.1f, 0.1f, 1, filter, UnityEngine.Color.white, "Hook end");
