...
public class RopeNet : MonoBehaviour
{
    ...
    private ObiRope CreateRope(Vector3 pointA, Vector3 pointB)
    {
        ...
        blueprint.path.AddControlPoint(pointA, -direction, direction, Vector3.up, 0.1f, 0.1f, 1, 1, UnityEngine.Color.white, "A");
        blueprint.path.AddControlPoint(pointB, -direction, direction, Vector3.up, 0.1f, 0.1f, 1, 1, UnityEngine.Color.white, "B");
