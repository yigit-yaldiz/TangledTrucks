...
public class HosePump : MonoBehaviour {
    ...
    public UnityEngine.Color bulgeColor = UnityEngine.Color.cyan;
    ...
    private void Rope_OnBeginStep(ObiActor actor, float stepTime)
    {
        ...
        for (int i = 0; i < rope.solverIndices.Length; ++i)
        {
            ...
            rope.solver.colors[solverIndex] = UnityEngine.Color.Lerp(UnityEngine.Color.white, bulgeColor, sine);
        }
