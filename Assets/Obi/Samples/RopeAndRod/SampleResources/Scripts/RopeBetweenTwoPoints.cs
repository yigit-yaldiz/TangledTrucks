...
public class RopeBetweenTwoPoints : MonoBehaviour
{
    ...
    void Generate()
    {
        if (start != null && end != null)
        {
            ...
            blueprint.path.AddControlPoint(startPositionLS, -tangentLS, tangentLS, Vector3.up, 0.1f, 0.1f, 1, filter, UnityEngine.Color.white, "start");
            blueprint.path.AddControlPoint(endPositionLS, -tangentLS, tangentLS, Vector3.up, 0.1f, 0.1f, 1, filter, UnityEngine.Color.white, "end");
